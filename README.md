...
| 分支 | 说明 |
|------|------|
| `feat/file-manager` | 基础版本 — 树视图浏览、导航栏、图标系统、设置面板、文件操作（新建/重命名/删除） |
| `feat/file-clipboard` | 剪贴板增强 — 复制/粘贴/剪切、系统剪贴板互通、覆盖冲突提示、右键菜单快捷键 |
| `feat/file-ops` | 主窗口集成 — Activity Bar + 可拖拽侧面板布局，将文件管理器嵌入工具箱主界面 |
